package ru.yandex.practicum.lesson_7.lesson_1_1;
...
@Target({ElementType.METHOD, ElementType.TYPE})  // указывает,что аннотация будет использоваться для пометки методов, подлежащих проверке
@interface CorrectImplementation {
    ...
    Class<?>[] expectedParameterTypes() default void.class;
}
